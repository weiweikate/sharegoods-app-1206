...
const RCTShowDynamicView = requireNativeComponent('ShowDynamicView', ShowDynamicView);
...
export default class ShowDynamicView extends Component {

    replaceData = (index, num) => {
        UIManager.dispatchViewManagerCommand(
            this.getHandle(),
            UIManager.ShowDynamicView.Commands.replaceData,
            [index, num]
        );
    };
    addDataToTop = (data) => {
        UIManager.dispatchViewManagerCommand(
            this.getHandle(),
            UIManager.ShowDynamicView.Commands.addDataToTop,
            [data]
        );
    };
    ...
    replaceItemData = (index,data)=>{
        UIManager.dispatchViewManagerCommand(
            this.getHandle(),
            UIManager.ShowDynamicView.Commands.replaceItemData,
            [index,data]
        );
    }
    ...
    scrollToTop = ()=>{
        UIManager.dispatchViewManagerCommand(
            this.getHandle(),
            UIManager.ShowDynamicView.Commands.scrollToTop,
            []
        );
    }
