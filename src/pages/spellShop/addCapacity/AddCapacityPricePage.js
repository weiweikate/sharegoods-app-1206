...
export class AddCapacityPricePage extends BasePage {
    ...
    _renderItem = ({ item }) => {
        const { isSelected, originPrice } = item;
        ...
        return (
            <View>
                ...
                }]} onPress={this._itemBtnAction}>
                    <Text style={[styles.itemLeftText, { color: itemColor }]}>100人</Text>
                    <View style={styles.itemRightView}>
                        {originPrice ?
                            <Text style={styles.itemOriginText}>¥40</Text> : null}
                        <Text style={{ fontSize: 17, color: itemColor }}>¥40</Text>
                    </View>
                </NoMoreClick>
            </View>
        );
...
const styles = StyleSheet.create({
    ...
    itemOriginText: {
        fontSize: 10, color: DesignRule.textColor_instruction, marginRight: 5
    },
    footerView: {
        marginTop: 15,
