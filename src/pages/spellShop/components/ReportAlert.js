        ...
        return (
            <Modal visible={this.state.modalVisible} onRequestClose={this._closeAnimated}
                ...
                <View style={[styles.container, { backgroundColor: 'transparent' }]}>
                    ...
                    >
                        <Image style={{ position: 'absolute', top: 0, zIndex: 1, alignSelf: 'center',width: 90,
                            height: 90 }}
                               source={KeFuIcon}/>
                        <View style={styles.whitePanel}>
                            ...
                            <View style={styles.btnContainer}>
                                <TouchableOpacity activeOpacity={0.7} onPress={this._clickOk}
                                                  style={styles.submitContainer}>
                                    <Text style={styles.submitTitle}>提交</Text>
                                </TouchableOpacity>
                                <TouchableOpacity activeOpacity={0.7} onPress={this._closeAnimated}
