...
export default ({ data, isSelected, balance, press, selectedTypes, disabled }) => {
    ...
    return <TouchableOpacity activeOpacity={0.7} style={styles.cell} disabled={disabled}
                             onPress={() => press && press()}>
        ...
        <Image source={selected ? res.button.selected_circle_red : res.button.unselected_circle} style={styles.checkImg}
               resizeMode={'stretch'}/>
    </TouchableOpacity>;
}
