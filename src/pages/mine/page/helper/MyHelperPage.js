...
export default class MyHelperPage extends BasePage {
                        ...
                        <View key={index} style={styles.hotQuestionStyle}>
                            ...
                            <View style={styles.hot2ViewStyle}>
                                <View style={{flex: 1, justifyContent: 'center',}}>
                                    <UIText onPress={()=>this.gotoquestionDetail(item.list[0].id)} style={{marginLeft: 10,fontSize: 15, color: "#666666"}} value={item.list.length>0?item.list[0].title:""}/>
                                </View>
                                <View style={{width: "100%", height: 0.5, backgroundColor: "#c9c9c9"}}/>
                                <View style={{flex: 1, justifyContent: 'center', borderColor: "#c9c9c9",}}>
                                    <UIText onPress={()=>this.gotoquestionDetail(item.list[0].id)} style={{marginLeft: 10,fontSize: 15, color: "#666666"}} value={item.list.length>1?item.list[1].title:""}/>
                                </View>
                            </View>
                        </View>
                    )
    ...
    renderBodyView = ()=> {
        return (
            <View style={{flex:1}}>
                <ScrollView>
                    <View style={{alignItems: 'center', marginTop: 1, flexDirection: 'row', backgroundColor: 'white'}}>
                    ...
                    <View style={{width: ScreenUtils.width, height: 32, justifyContent: 'center', backgroundColor: '#F6F6F6'}}>
                        <Text style={{
                    ...
                    <View style={{alignItems:'center', height:87, flexDirection:'row',marginTop:10,backgroundColor:'white'}}>
                ...
                <View style={{
                    ...
                    <TouchableOpacity style={{width: 58, height: 54, alignItems: 'center', justifyContent: 'center', flex: 1}} onPress={()=>this.jumpQYIMPage()}>
