...
export default class CommonTwoChoiceModal extends Component {
    ...
    renderButton=()=>{
        return(this.props.isConfirmButtonLeft?
            <View style={{flexDirection:'row',justifyContent:'space-between',marginBottom:25,marginLeft:25,marginRight:25}}>
                <TouchableOpacity style={{width:110,height:35,backgroundColor:color.red,justifyContent:'center',borderRadius:5,}} onPress={()=>this.props.yes()}>
                    <Text style={{color:color.white,textAlign:'center',}}>{this.props.detail.yes}</Text>
                </TouchableOpacity>
                <TouchableOpacity style={{width:110,height:35,backgroundColor:color.gray_DDD,justifyContent:'center',borderRadius:5,}} onPress={()=>this.props.no()}>
        ...
        return(
            <View style={{flex:1,justifyContent:'center',alignContent:'center'}}>
                <View style={{justifyContent:'center',flexDirection:'row'}}>
                    <Image source={this.props.backgroundImg?this.props.backgroundImg:BonusExchangeSucceedBackground} style={{position: 'absolute',}}/>
                    <View style={{height:272,width:295,position: 'absolute',justifyContent:'flex-start',alignItems:'flex-end'}}>
                    ...
                    <View style={{height:272,width:295,justifyContent:'space-between'}}>
                        <View style={{flex:1,alignContent:'center',alignItems:'center',marginTop:100,paddingLeft:26,paddingRight:26}}>
