    ...
    renderContent() {
        ...
        return (
            <View style={styles.modal}>
                ...
                >
                    <View style={{
                        height: ScreenUtils.autoSizeWidth(80),
                        alignItems: 'center',
                        ...
                        <MRText style={{
                            ...
                            marginTop: ScreenUtils.autoSizeWidth(40)
                        }}>恭喜您获得奖励</MRText>
                    </View>
                    {
                        alertData.map((item) => {
                            ...
                            return (
                                <ImageBackground source={bgs[GiftType[code] - 1]} style={{
                                    ...
                                    <View style={{
                                        justifyContent: 'center',
                                        marginLeft: ScreenUtils.autoSizeWidth(6)
                                    }}>
                                        <MRText style={{
    ...
    renderContent() {
        ...
        return (
            <View style={styles.modal}>
                <TouchableOpacity
                    activeOpacity={0.7}
                    style={{ width: ScreenUtils.width, alignItems: 'center' }}
                    onPress={() => {
