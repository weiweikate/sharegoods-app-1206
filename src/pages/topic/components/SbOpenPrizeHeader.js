...
export default class SbOpenPrizeHeader extends Component {
    ...
    _downItemViewClick = (index, item) => {
        ...
        if (index > 2) {
            ...
            this.refs.scroll.scrollTo  && this.refs.scroll.scrollTo({ x: offsetX, y: 0, animated: true });
        } else {
            this.refs.scroll.scrollTo && this.refs.scroll.scrollTo({ x: 0, y: 0, animated: true });
        }
