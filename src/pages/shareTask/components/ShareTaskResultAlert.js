                    ...
                    <View style={styles.content}>
                        {
                            this.props.success ? (
                                <View style = {{flex: 1, alignItems: 'center'}}>
                                    ...
                                    <View style = {{flexDirection: 'row', alignItems: 'flex-end', marginTop: 5, width: autoSizeWidth(230)}}>
                                        <View style = {{flex: 1}}/>
                                        <UIText value={'¥'} style={{color: '#FF1A54', fontSize: autoSizeWidth(14), marginBottom: 3}}/>
                                        <UIText value={this.props.money} style={{color: '#FF1A54', fontSize: autoSizeWidth(34)}}/>
                                        <View style = {{flex: 1}}>
