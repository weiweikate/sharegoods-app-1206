                    ...
                    <View style={styles.bg}>
                        ...
                        <RefreshFlatList url={API.listAvailable}
                                         ...
                                         renderEmpty={() => {
                                             return (
                                                 <View style={{
                                                     height: autoSizeWidth(480 - 95),
                                                     alignItems: 'center',
                                                     justifyContent: 'center'
                                                 }}>
                                                     <Image source={emptyIcon} style={{
                                                         height: autoSizeWidth(140),
                                                         width: autoSizeWidth(244)
                                                     }}/>
                                                     <Text style={{
                                                         color: '#666666',
                        ...
                        <View style={{ height: autoSizeWidth(50) + safeBottom }}>
                            <TouchableOpacity
                                activeOpacity={0.7}
                                style={[DesignRule.style_bigRedBorderBtn, {
                                ...
                                onPress={() => {
                                    this.close();
                                    this.callBack && this.callBack('giveUp');
                                }}
                            >
                                <Text
                                    style={[DesignRule.style_btnWhiteText, { color: DesignRule.textColor_instruction }]}>不使用优惠券</Text>
                            </TouchableOpacity>
                        </View>
                    </View>
                </View>
