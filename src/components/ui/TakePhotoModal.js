...
import circleSelect from '../../pages/mine/res/userInfoImg/circleSelect.png';
import circleUnselect from '../../pages/mine/res/userInfoImg/circleUnselect.png';
import {
     UIText,UIImage
} from './../ui';
        ...
        return(
            <View style={{justifyContent:'center',alignItems:'center',alignContent:'center',flexDirection:'row'}}>
                <View style={{flex:1,backgroundColor:color.white,justifyContent:'center'}}>
                    <View style={{flexDirection:'row',height:40,backgroundColor:color.gray_EEE,justifyContent:'flex-end',alignItems:'center'}}>
                        <UIText value={'取消'} style={{color:color.black_999,fontSize:15,marginRight:16}} onPress={()=>{
...
const styles = StyleSheet.create({
    modalStyle: {
        ...
        height:60,backgroundColor:color.page_background,justifyContent:'center',textAlign:'center',alignItems:'center',alignContent:'center'
    },textStyle:{
