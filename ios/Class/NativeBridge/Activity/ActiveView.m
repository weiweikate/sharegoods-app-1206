...
@interface ActiveView()<UITableViewDelegate,UITableViewDataSource,UIScrollViewDelegate>
...
-(void)setUI{
  ...
  [tableView registerClass:[ActivityCell class] forCellReuseIdentifier:ID];
...
- (CGFloat)tableView:(UITableView *)tableView heightForRowAtIndexPath:(NSIndexPath *)indexPath
{
  ...
  return [self.tableView cellHeightForIndexPath:indexPath model:_dataSource[indexPath.row] keyPath:@"model" cellClass:[ActivityCell class] contentViewWidth: self.frame.size.width];
}
