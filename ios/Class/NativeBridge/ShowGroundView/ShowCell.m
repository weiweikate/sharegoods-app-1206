...
- (void)setModel:(ShowQuery_dataModel *)model
{
  ...
  if ([showImage containsString:@"sharegoodsmall"]) {
    showImage = [NSString stringWithFormat:@"%@?x-oss-process=image/resize,m_lfit,w_%0.0lf,h_%0.0lf/quality,Q_75/format,webp",showImage,itemWidth,itemWidth/model.aspectRatio];
  }
