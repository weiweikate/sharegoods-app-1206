...
static inline CGFloat HYFDegreesToRadians(CGFloat degrees)
{
...
+ (UIImage *)rotatedByDegrees:(CGFloat)degrees withImage:(UIImage *)image
{
    ...
    CGAffineTransform t = CGAffineTransformMakeRotation(HYFDegreesToRadians(degrees));
    ...
    CGContextRotateCTM(bitmap, HYFDegreesToRadians(degrees));
...
+ (UIImage *)rotatedWithImage:(UIImage *)image
{
    // calculate the size of the rotated view's containing box for our drawing space
    UIView *rotatedViewBox = [[UIView alloc] initWithFrame:CGRectMake(0, 0, image.size.width, image.size.height)];
    CGAffineTransform t = CGAffineTransformMakeRotation(HYFDegreesToRadians(90));
    rotatedViewBox.transform = t;
    CGSize rotatedSize = rotatedViewBox.frame.size;
    ...
    //   // Rotate the image context
    CGContextRotateCTM(bitmap, HYFDegreesToRadians(90));
