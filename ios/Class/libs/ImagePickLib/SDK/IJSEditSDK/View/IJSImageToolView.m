...
//    self.smileButton = smileButton;
    ...
    textButton.frame = CGRectMake(_panButton.js_centerX + buttonSzieWidth / 2 + marginLeft, toolButtonCenterY, buttonSzieWidth, buttonSzieWidth);
