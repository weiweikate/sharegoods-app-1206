...
@ReactModule(name = MRAsyncStorageModule.NAME)
public class MRAsyncStorageModule
    ...
    public MRAsyncStorageModule(ReactApplicationContext reactContext) {
        this(reactContext, AsyncTask.THREAD_POOL_EXECUTOR);
    }

    @VisibleForTesting
    MRAsyncStorageModule(ReactApplicationContext reactContext, Executor executor) {
        super(reactContext);
