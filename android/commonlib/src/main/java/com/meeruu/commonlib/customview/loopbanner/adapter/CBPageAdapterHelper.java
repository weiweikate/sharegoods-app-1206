package com.meeruu.commonlib.customview.loopbanner.adapter;

import android.support.v7.widget.RecyclerView;
import android.view.View;
import android.view.ViewGroup;

import com.meeruu.commonlib.customview.loopbanner.utils.ScreenUtil;

public class CBPageAdapterHelper {
    public static int sPagePadding = 10;
