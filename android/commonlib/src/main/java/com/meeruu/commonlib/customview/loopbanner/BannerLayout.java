...
import com.meeruu.commonlib.customview.loopbanner.layoutmanager.BannerLayoutManager;
import com.meeruu.commonlib.customview.loopbanner.layoutmanager.CenterSnapHelper;
...
public class BannerLayout extends FrameLayout {
    ...
    protected void initView(Context context, AttributeSet attrs) {
        ...
        a.recycle();
        //轮播图部分
        mRecyclerView = new LoopViewPager(context);
