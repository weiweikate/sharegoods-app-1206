...
import com.mingrong.MainApplication;
import com.mingrong.event.AppPayEvent;
import com.mingrong.utils.aipay.PayResult;
                ...
                switch (msg.what) {
                    case SDK_PAY_FLAG: {
                        ...
                        if (TextUtils.equals(resultStatus, "9000")) {
                            ...
                            Toast.makeText(MainApplication.getContext(), "支付成功", Toast.LENGTH_SHORT).show();
                        } else {
                            ...
                            if (TextUtils.equals(resultStatus, "8000")) {
                                ...
                                event.setAliPayResult(null);
                                promise.resolve(gson.toJson(event));
                                Toast.makeText(MainApplication.getContext(), "支付结果确认中", Toast.LENGTH_SHORT).show();
                                ...
                                event.setAliPayResult(null);
                                promise.resolve(gson.toJson(event));
                                Toast.makeText(MainApplication.getContext(), "支付失败", Toast.LENGTH_SHORT).show();
                            }
                        }
                        break;
                    }
                    case SDK_CHECK_FLAG: {
                        ...
                        event.setAliPayResult(null);
                        promise.resolve(gson.toJson(event));
                        Toast.makeText(MainApplication.getContext(), "检查结果为：" + msg.obj, Toast.LENGTH_SHORT).show();
                        break;
                    }
                    default:
                        break;
