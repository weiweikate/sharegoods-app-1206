package com.meeruu.MRBanner.mzbanner;
...
import com.meeruu.MRBanner.mzbanner.transformer.CoverModeTransformer;
import com.meeruu.MRBanner.mzbanner.transformer.ScaleYTransformer;
...
public class MZBannerView<T> extends RelativeLayout {
    ...
    public MZBannerView(@NonNull Context context, boolean isOpenMz) {
        super(context);
        this.mIsOpenMZEffect = isOpenMz;
        init();
    }
    ...
    /**
     * 开始轮播
     * <p>应该确保在调用用了{@link MZBannerView {@link #setPages(List, com.meeruu.MRBanner.mzbanner.holder.MZHolderCreator)}} 之后调用这个方法开始轮播</p>
     */
    public void start() {
     ...
     * @param mzHolderCreator ViewHolder生成器 {@link com.meeruu.MRBanner.mzbanner.holder.MZHolderCreator} And {@link com.meeruu.MRBanner.mzbanner.holder.MZViewHolder}
     */
