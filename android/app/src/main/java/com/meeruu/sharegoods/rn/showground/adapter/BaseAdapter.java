...
import com.meeruu.sharegoods.rn.showground.listener.OnItemClickListeners;
import com.meeruu.sharegoods.rn.showground.listener.OnLoadMoreListener;
...
public abstract class BaseAdapter<T> extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    protected abstract void convert(RecyclerView.ViewHolder holder, T data);
