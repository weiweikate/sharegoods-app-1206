...
public class FolderTextView extends AppCompatTextView {
    ...
    // 默认是否可以点击尾部
    private static final boolean DEFAULT_CAN_CLICK_TAIL = true;
    ...
    // 尾部按钮是否可以点击
    private boolean mCanClickTail = false;
    ...
    public FolderTextView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mCanClickTail = a.getBoolean(R.styleable.FolderTextView_canClickTail, DEFAULT_CAN_CLICK_TAIL);
