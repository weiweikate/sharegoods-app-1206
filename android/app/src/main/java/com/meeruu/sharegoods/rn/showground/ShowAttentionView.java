...
public class ShowAttentionView implements IShowgroundView, SwipeRefreshLayout.OnRefreshListener {
    ...
    private com.meeruu.sharegoods.rn.showground.event.onSharePressEvent onSharePressEvent;
    private com.meeruu.sharegoods.rn.showground.event.onDownloadPressEvent onDownloadPressEvent;
    ...
    private void initData() {
        presenter = new ShowAttentionPresenter(this);
        if (mHandler == null) {
