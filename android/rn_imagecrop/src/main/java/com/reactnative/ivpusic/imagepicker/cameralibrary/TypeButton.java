...
public class TypeButton extends View{
    ...
    public static final int TYPE_EDIT = 0x003;
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if(button_type == TYPE_EDIT){
            ...
            path.moveTo(center_X - 1.6f*index , center_Y - index);
            path.lineTo(center_X + 0.5f*index, center_Y - index);
            path.moveTo(center_X + 0.9f*index,center_Y - 1.4f*index);
            path.lineTo(center_X + 0.9f*index,center_Y - 0.6f*index);
            path.moveTo(center_X + 0.9f*index,center_Y - index);
            path.lineTo(center_X + 1.6f*index,center_Y - index);

            path.moveTo(center_X - 1.6f*index , center_Y  );
            path.lineTo(center_X - 0.9f*index, center_Y );
            path.moveTo(center_X - 0.5f*index,center_Y - 0.4f*index);
            path.lineTo(center_X - 0.5f*index,center_Y + 0.4f*index);
            path.moveTo(center_X - 0.5f*index,center_Y );
            path.lineTo(center_X + 1.6f*index,center_Y);

            path.moveTo(center_X - 1.6f*index , center_Y +index );
            path.lineTo(center_X + 0.5f*index, center_Y +index);
            path.moveTo(center_X + 0.9f*index,center_Y + 0.6f*index);
            path.lineTo(center_X + 0.9f*index,center_Y + 1.4f*index);
            path.moveTo(center_X + 0.9f*index,center_Y +index);
            path.lineTo(center_X + 1.6f*index,center_Y +index);
