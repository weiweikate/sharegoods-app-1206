package com.reactnative.ivpusic.imagepicker.cameralibrary.state;

import android.graphics.Bitmap;
import android.view.Surface;
import android.view.SurfaceHolder;

import com.reactnative.ivpusic.imagepicker.cameralibrary.CameraInterface;
...
public class BorrowPictureState implements State {
    ...
    public void edit(Bitmap bitmap) {
        machine.getView().showPicture(bitmap, true);
