...
import com.reactnative.ivpusic.imagepicker.picture.lib.imaging.core.IMGMode;
import com.reactnative.ivpusic.imagepicker.picture.lib.imaging.core.IMGText;
import com.reactnative.ivpusic.imagepicker.picture.lib.imaging.core.clip.ClipRatioConfigsPopupWindow;
import com.reactnative.ivpusic.imagepicker.picture.lib.imaging.view.IMGColorGroup;
import com.reactnative.ivpusic.imagepicker.picture.lib.imaging.view.IMGView;
...
abstract class IMGEditBaseActivity extends Activity implements View.OnClickListener, IMGTextEditDialog.Callback, RadioGroup.OnCheckedChangeListener, DialogInterface.OnShowListener, DialogInterface.OnDismissListener {
    ...
    private ClipRatioConfigsPopupWindow clipRatioConfigsPopupWindow;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (bitmap != null) {
            ...
            clipRatioConfigsPopupWindow = new ClipRatioConfigsPopupWindow(this);
            clipRatioConfigsPopupWindow.setItemClickListener(new ClipRatioConfigsPopupWindow.ItemClickListener() {
                @Override
    ...
    public void onClick(View v) {
        ...
        if (vid == R.id.rb_doodle) {
            ...
            onRotateClipClick();
        } else if (vid == R.id.ib_clip_ratio) {
            clipRatioConfigsPopupWindow.showAsDropDown(root);
        }
    }
    ...
    public abstract void onRatioClipClick();
