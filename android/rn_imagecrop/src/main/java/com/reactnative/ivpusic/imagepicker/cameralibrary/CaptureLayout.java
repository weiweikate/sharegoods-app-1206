...
import com.reactnative.ivpusic.imagepicker.cameralibrary.listener.ReturnListener;
...
public class CaptureLayout extends FrameLayout {
    ...
    private TypeButton btn_edit;          //取消按钮
    ...
    public void startTypeBtnAnimator() {
        ...
        btn_edit.setVisibility(isPicture ? VISIBLE : INVISIBLE);
...
//                resetCaptureLayout();
        ...
        btn_edit = new TypeButton(getContext(), TypeButton.TYPE_EDIT, button_size);
        final LayoutParams btn_edit_param = new LayoutParams(LayoutParams.MATCH_PARENT, LayoutParams.MATCH_PARENT);
        btn_edit_param.gravity = Gravity.CENTER;
